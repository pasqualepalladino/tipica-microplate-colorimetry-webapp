...
function buildReportLegendRows(unitLabel: string): XlsxRow[] {
  return [
    ...
    { Term: "CommonFactorsN", Meaning: "Number of common factors used in the score", Formula: "4 for R2_cal, R2_std, SlopeAgreement and LOQ; 1 for calibration-only or stdadd-only fallbacks", Unit: "integer", "Where used": "METHOD_COMPARISON", "Shown when": "always", Notes: "Used to avoid comparing scores obtained from different formulas." },
