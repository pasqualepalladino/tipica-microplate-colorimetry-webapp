...
function App() {
  ...
  const handleExportCompleteAnalysisPackage = useCallback(async () => {
    ...
    try {
      ...
      const addTextFile = (name: string, text: string, type: string) => {
      ...
      if (calibrationFits.length > 0) {
        addTextFile('calibration_results.csv', calibrationFitsToCsv(calibrationFits), 'text/csv;charset=utf-8');
      }
      ...
      if (unknownResults.length > 0) {
        addTextFile('unknown_results.csv', unknownResultsToCsv(unknownResults), 'text/csv;charset=utf-8');
      }
      ...
      if (image && measurements.length > 0 && wells.length === 96) {
        ...
        if (geometry) {
          ...
          addTextFile('background_cell_diagnostics.csv', cellDiagnosticsCsv, 'text/csv;charset=utf-8');
