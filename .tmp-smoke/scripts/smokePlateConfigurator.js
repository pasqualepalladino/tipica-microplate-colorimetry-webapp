import { buildDefaultPlateDefaults, buildPlateMapTemplateCsv, collectPlateState, importPlateMapCsv, parseCellEntry, rowIndexFromLabel, rowLabelFromIndex, wellId, wellConfigsToPlateEditorState, } from '../src/core/plateConfigurator.js';
...
function testWellConfigsToPlateEditorState() {
    const plateMap = [];
